-- Migration 043 (renumbered from this fork's 040 to clear the collision
-- with upstream's 040_contact_business_scoped_user_id): Add archive support to conversations.
--
